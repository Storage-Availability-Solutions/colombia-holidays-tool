...
function is_holiday(date){
    ...
    let holidays = nequiHolidays.getColombiaHolidaysByYear(datetemp.getFullYear());
    let result = holidays.filter(holiday=>{
        let holidayDate = new Date(holiday.holiday);
        holidayDate.setDate(holidayDate.getDate()+1);
        return datetemp.getMonth() == holidayDate.getMonth() && datetemp.getFullYear() == holidayDate.getFullYear() && 
